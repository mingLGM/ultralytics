...
if __name__ == '__main__':
    ...
    # 数据集文件夹名称
    Dataset_root = r'E:\work\Data\QR'
    labelme_json_path = Dataset_root + '/jsons'
    yolo_txt_path = Dataset_root+'/labels'
    ...
    for labelme_path in os.listdir():
        try:
            num += process_single_json(labelme_path, save_folder=yolo_txt_path)
        except:
